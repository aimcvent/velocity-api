...
public class GreaterThanOrEqualsConstraint implements ArgumentConstraint<Number> {

    private final Class<? extends Number> type;
    private final Number value;

    public GreaterThanOrEqualsConstraint(Class<? extends Number> type, Number value) {
        this.type = type;
        this.value = value;
    }
